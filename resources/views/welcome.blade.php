      ...
      <div class="carousel-item active">
        ...
        <div class="container">
          <div class="carousel-caption text-start">
            ...
            <p><a class="btn btn-lg btn-light" href="#">Gimnasios</a></p>
          </div>
        </div>
      </div>
      ...
      <image href="/img/entreimg.png"/>
        ...
        <div class="container">
          <div class="carousel-caption">
            ...
            <p><a class="btn btn-lg btn-light" href="#">Plan</a></p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption text-end">
            <h1>Vive saluble</h1>
            <p>Aorende a cuidar tu cuerpo</p>
            <p><a class="btn btn-lg btn-light" href="#">Nosotros</a></p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container marketing">
    ...
    <div class="row featurette">
      <div class="col-md-7">
        ...
        <p class="lead">no jueguen free fire</p>
      </div>
      <div class="col-md-5">
